...
public class QuestionB {
    ...
    public static void main(String[] args) {
        ...
        int n = sc.nextInt();
        DirectedMatrixGraph grafo = new DirectedMatrixGraph(n);
        int m = sc.nextInt();
        for (int i = 0; i < m; i++) {
            int x = sc.nextInt();
            int y = sc.nextInt();
            grafo.setEdge(x-1, y-1, 1);
        }
        Stack<Integer> topography = grafo.topoGraphSort();
    ...
    static class DirectedMatrixGraph {
        int[][] matrix;
        int numEdge;
        int[] mark;
